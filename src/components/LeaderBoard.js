                  ...
                  <Grid.Row>
                    ...
                    <Grid.Column width={8} textAlign="left">
                      ...
                      <Grid>
                        ...
                        <Grid.Column width={4}><p><strong>{user.noOfAnsweredQuestions}</strong></p></Grid.Column>
                      </Grid>
                      <Divider />
                      <Grid>
                        <Grid.Column width={12}><p><strong>Created Questions</strong></p></Grid.Column>
                        <Grid.Column width={4}><p><strong>{user.noOfCreatedQuestions}</strong></p></Grid.Column>
                      </Grid>
                    </Grid.Column>
